...
function createDivergingChart(countryStats) {
    ...
    const width = Math.min(1200, container.node().offsetWidth) - margin.left - margin.right;
    ...
    observer.observe(document.getElementById('viz1-section'));
}
...
function createSlopeChart(data) {
    ...
    const width = Math.min(1100, container.node().offsetWidth) - margin.left - margin.right;
    ...
    observer.observe(document.getElementById('viz2-section'));
}
